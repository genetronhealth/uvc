...
all : uvc-1-fopenmp-thread.out uvc-1-cpp-std-thread.out uvc-2-fopenmp-thread.debug uvc-2-cpp-std-thread.debug uvc-3.debug uvc-3.out
...
bcf_formats_generator1.debug : bcf_formats_generator1.cpp version.h 
	$(CXX) -o bcf_formats_generator1.debug $(CXXFLAGS) bcf_formats_generator1.cpp
...
bcf_formats.step1.hpp : bcf_formats_generator1.out
	./bcf_formats_generator1.debug > bcf_formats.step1.hpp
