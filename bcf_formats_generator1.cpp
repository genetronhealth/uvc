...
const std::vector<BcfFormatStruct> FORMAT_VEC = {
    ...
    BcfFormatStruct("APDP"  , 6+4,       BCF_INTEGER, "Total segment depth, segment depths within the indel length of insertion/deletion, segment depths within the tandem-repeat track length of insertion/deletion, segment depth of high quality, sum of squares of insertion lengths, sum of squares of deletion lengths, sum of the inverses of insertion lengths, and sum of the inverses of deletion lengths."),
    ...
    */
    ...
    BcfFormatStruct("__A2a" , 1,         BCF_SEP,     "Depths of the raw sequencing segments for (all alleles) and (the padded deletion allele)."),
    ...
    */
    ...
    BcfFormatStruct("__a2a" , 1,         BCF_SEP,     "As before."),
