...
const std::vector<BcfFormatStruct> FORMAT_VEC = {
    ...
    BcfFormatStruct("GSTa"     , 8, BCF_SIG_INT, "Genotype Statistics of this allele"),
    ...
    BcfFormatStruct("GSTb"     , 8, BCF_SIG_INT, "Genotype Statistics of other alleles"),
    ...
    BcfFormatStruct("__ad"     , 1, BCF_SEP,     "Average base quality for ALL/ALT (bAllBQ/bAltBQ) and duplication bias (aDB). All biases are percentages where 100% means no bias."), // global 
