...
const std::vector<BcfFormatStruct> FORMAT_VEC = {
    ...
    BcfFormatStruct("CDP21" , 2,         BCF_INTEGER, "SSCS singleton on the forward and reverse read orientations for all alleles by sum. ").sscs(),
    ...
    BcfFormatStruct("CDPM"  , 2,         BCF_INTEGER, "Depth of PCR fragments supporting the UMI-consensus allele on the forward and reverse read orientations for all alleles by sum. ").sscs(),
    ...
    BcfFormatStruct("CDPm"  , 2,         BCF_INTEGER, "Depth of PCR fragments not supporting the UMI-consensus allele on the forward and reverse read orientations for all alleles by sum. ").sscs(),
    
    BcfFormatStruct("CDPD"  , 2,         BCF_INTEGER, "DSCS-excluded SSCS depths on the forward and reverse read orientations. "),
