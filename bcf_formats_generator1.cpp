...
const std::vector<BcfFormatStruct> FORMAT_VEC = {
    ...
    BcfFormatStruct("__ba"     , 1, BCF_SEP,     "Average base quality for ALL/ALT (bAllBQ/bAltBQ) and duplication bias (aDB). All biases are percentages where 100% means no bias."), // global 
    ...
    BcfFormatStruct("__bb"     , 1, BCF_SEP,     "Forward&reverse max-bias base distances to left/right end positions (T1PTL/T1PTR) and position bias (T1PBL/T1PBR) [base read, duped]"), 
    ...
    BcfFormatStruct("__bc"     , 1, BCF_SEP,     "Forward&reverse sum of : base distances to left/right end positions (T1SDL/T1SDR) and non-normalized/normalized strand bias (T1SB1/T1SBR) [base read, duped]"),
    ...
    BcfFormatStruct("__bd"     , 1, BCF_SEP,     "Forward&reverse depth (DP1), allele depth (AD1), allele depth after weak filter (AD2), quality threshold for weak filter (QT2) [base read, duped]"),
    ...
    BcfFormatStruct("__be"      , 1, BCF_SEP,     "Forward&reverse allele depth after strong filter (AD3), quality threshold for strong filter (QT3), and variant quality after strong filter (VQ3) [duped]"),
    ...
    BcfFormatStruct("__bf"      , 1, BCF_SEP,     "Forward&reverse allele root-mean-squre MQ (bMQ1) and (sum of squared MQ) / (sum of MQ) (bMQ2), where MQ is mapping quality, and the same for base quality BQ [duped]"),
    ...
    BcfFormatStruct("__bg"      , 1, BCF_SEP,     "Forward&reverse total depth (bDPLQ), ALT depth (bADLQ), and REF depth (bRDLQ) supported by low-quality (LQ) bases [duped]"),
    ...
    BcfFormatStruct("__ca"      , 1, BCF_SEP,     "Same as b_a but for single-strand families instead of reads [consensus family, deduped]"),
    ...
    BcfFormatStruct("__cb"     , 1, BCF_SEP,     "Same as b_b but for single-strand families instead of reads [consensus family, deduped]"), 
    ...
    BcfFormatStruct("__cc"      , 1, BCF_SEP,     "Same as b_c but for single-strand families instead of reads [consensus family, deduped]"), 
    ...
    BcfFormatStruct("__cd"     , 1, BCF_SEP,     "Same as b_d but for single-strand families instead of reads [consensus family, deduped]"),
    ...
    BcfFormatStruct("__ce"     , 1, BCF_SEP,     "Forward&reverse number of read supports generated by signal (cMajor) and noise (cMinor) inferred from heterogeneity of families, "
    ...
    BcfFormatStruct("__da"     , 1, BCF_SEP,     "Same as b_a and c_a but for duplex families [duplex family, DSCS1-deduped]"),
