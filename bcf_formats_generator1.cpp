...
const std::vector<BcfFormatStruct> FORMAT_VEC = {
    ...
    BcfFormatStruct("cFA"      , 1, BCF_FLOAT,   "Frequency of the allele [consensus family, deduped]"),
    ...
    BcfFormatStruct("a_b"      , 1, BCF_SEP,     "Average base quality for ALL/ALT (bAllBQ/bAltBQ) and duplication bias (aDB). All biases are percentages where 100% means no bias."), // global 
