...
const std::vector<BcfFormatStruct> FORMAT_VEC = {
    ...
    BcfFormatStruct("DP"       , 1, BCF_INTEGER, "Deduped fragment depth supporting any allele [consensus family, deduped]"),
    BcfFormatStruct("FA"       , 1, BCF_FLOAT,   "Frequency of the allele [consensus family, deduped]"),
    BcfFormatStruct("bDP"      , 1, BCF_INTEGER, "Deduped fragment depth supporting any allele [base read, duped]"),
    BcfFormatStruct("bFA"      , 1, BCF_FLOAT,   "Frequency of the allele [base read, duped]"),
    BcfFormatStruct("a_a"      , 1, BCF_SEP,     "Consensus/variant allele type/quality"),  
    ...
    BcfFormatStruct("a_b"      , 1, BCF_SEP,     "Average base quality for ALL/ALT (aAllBQ/aAltBQ) and duplication bias (aDB). All biases are percentages where 100% means no bias."), // global 
    BcfFormatStruct("aAllBQ"   , 2, BCF_INTEGER, "see above"),
    BcfFormatStruct("aAltBQ"   , 2, BCF_INTEGER, "see above"),
    ...
    BcfFormatStruct("c_e"      , 1, BCF_SEP,     "Number of read supports generated by signal (cMajor) and noise (cMinor) inferred from heterogeneity of families"),
    ...
    BcfFormatStruct("cDPTN"    , 2, BCF_INTEGER, "see above"),
