...
const std::vector<BcfFormatStruct> FORMAT_VEC = {
    ...
    BcfFormatStruct("__ad"     , 1, BCF_SEP,     "RMS/10 base quality for ALL/ALT (bAllBQ/bAltBQ) and duplication bias (aDB). All biases are percentages where 100% means no bias."), // global 
    ...
    BcfFormatStruct("__ce"     , 1, BCF_SEP,     "Forward&reverse consensus RMS and counter-harmonic qualities (same as bBQ), "
                                                 "number of read supports generated by signal (cMajor) and noise (cMinor) inferred from heterogeneity of families, "
