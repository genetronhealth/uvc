...
fillBySymbol(bcfrec::BcfFormat & fmt, const Symbol2CountCoverageSet & symbol2CountCoverageSet12, 
    ...
    if (fmtAD > 0 || is_rescued) {
        ...
        for (unsigned int t = 0; t < 2; t++) {
            ...
            int hetREF_likelim1 =  (int)(10.0/log(10.00) * 3.0 * MIN(logit2(fr_l / refmul * (1.0 + 0.0),     fa_l / altmul), 0.0));
            int hetALT_likelim1 =  (int)(10.0/log(10.00) * 3.0 * MIN(logit2(fa_l / altmul * (1.0 + 0.0),     fr_l / refmul), 0.0));         
            int homref_likelim1 =  (int)(10.0/log(10.00) * 3.0 * MIN(logit2(fr_l / refmul * any_contam_rate, fa_l / altmul), 0.0));
            int homalt_likelim1 =  (int)(10.0/log(10.00) * 3.0 * MIN(logit2(fa_l / altmul * any_contam_rate, fr_l / refmul), 0.0));
    ...
    if (prev_is_tumor) {
        ...
        */
        ...
        double t2n_syserr_q = MIN(MAX(0.0, 
                10.0/log(10.0) * log(MIN(2.0, (nAD1/nDP1) / (tAD1/tDP1 * t2n_sys_err_frac))) * MIN(tAD0, nAD0)), 
                60.0);
