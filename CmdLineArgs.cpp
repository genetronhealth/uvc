...
// *** 00. frequently used parameters
    ...
    ADD_OPTDEF(app, 
        ...
        "If this parameter is set to the empty string and the --fam-consensus-out-fastq parameter is not set to the empty string, "
    ...
    ADD_OPTDEF(app, 
        ...
        "The filename suffixes are \".R1.fastq.gz\", \".R2.fastq.gz\", and \".SE.fastq.gz\" for paired-end R1, paired-end R2, and single-end (or R1R2-merged) fastq files, respectively. "
        "If this parameter is set to the empty string, then do not generate any consensus FASTQ file. ");
