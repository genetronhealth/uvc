...
CommandLineArgs::initFromArgCV(int & parsing_result_flag, SequencingPlatform & inferred_sequencing_platform, int argc, const char *const* argv) {
    ...
    app.add_option("--t2n-add-contam-transfrac",t2n_mul_contam_transfrac, "Additive contamination rate for the fraction of tumor reads in the normal by read transfer", true); 
