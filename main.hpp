...
dealwith_segbias(
    ...
    */
    ...
    if (isGap) {
        ...
        // symbol_to_seg_format_depth_set[SEG_aXMB] += (bm150 > 30 ? (100 * mathsquare(30) / mathsquare(bm150)) : 100);
    } else {
...
fill_symbol_VQ_fmts(
    ...
    minABQa += (int)BETWEEN((int)xmratio - 5, 0, 30) + (int)BETWEEN((int)bmratio - 5, 0, 40); // 65
