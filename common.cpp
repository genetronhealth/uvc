...
const std::vector<std::string> ASSAY_TYPE_TO_MSG = std::vector<std::string> {
...
const std::vector<std::string> MOLECULE_TAG_TO_MSG = std::vector<std::string> {
...
const std::vector<std::string> SEQUENCING_PLATFORM_TO_MSG = std::vector<std::string> {
...
const std::vector<std::string> SEQUENCING_PLATFORM_TO_NAME = std::vector<std::string> {
...
const std::vector<std::string> PAIR_END_MERGE_TO_MSG = std::vector<std::string> {
