...
struct CommandLineArgs {
    ...
    double      phred_pow_sscs_origin = 44-38; // 10*log(2.7e-3/1.5e-4)/log(10)*3 = 37.658175 from https://doi.org/10.1073/pnas.1208715109
    double      phred_pow_sscs_indel_origin = -4; 
    double      phred_pow_dscs_origin = -14;
