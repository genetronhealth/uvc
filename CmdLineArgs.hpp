...
// *** 07. parameters related to read families
    ...
    uvc1_qual_t         fam_phred_indel_inc_before_barcode_labeling = 13; // can be 13 + 14 or 10 + 13
    ...
    double              fam_phred_pow_sscs_indel_origin = fam_phred_sscs_indel_open - fam_phred_indel_inc_before_barcode_labeling; // (13 * 3);
