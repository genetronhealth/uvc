...
struct CommandLineArgs {
    ...
    double      nonref_to_alt_frac_snv = 0.30; // 0.50 for practically removing tri-allelic sites.
    double      nonref_to_alt_frac_indel = 0.15;
    double      tnq_mult_snv = 1.0;
    double      tnq_mult_indel = 2.0; // maybe 3.0
