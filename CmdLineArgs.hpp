...
struct CommandLineArgs {
    ...
    uint32_t    phred_max_frag_indel_basemax = 30; // 40-10 // 37; // 42; // 37; // 35; // 25; // 34;
    ...
    uint32_t    phred_germline_polymorphism = 30+3; // probablity of germline polymorphism is between 1/500 and 1/1kb
